import { translateElement, translatePage } from "../../../../shared/localization.js";
    ...
    this.setOnRun(({interactionData}) => {
      ...
      if(typeExists) {
        ...
        if(interactionData.type !== undefined || interactionData.type !==null) {
          ...
          if(!document.querySelector(`.selectable-plugin-tile-action[data-plugin="${universal.cleanHTML(interactionData.plugin)}"][data-type="${universal.cleanHTML(interactionData.type)}"]`)) {
