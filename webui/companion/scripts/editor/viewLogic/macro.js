...
class Macro extends EditorViewLogic {
	constructor() {
		...
		pickOne.textContent = universal.translationKey("editor.sections.macro.control")
		select = document.createElement("select");

			const optionText = document.createElement("option")
			optionText.value = "text"
			optionText.textContent = universal.translationKey("editor.sections.macro.control.action_text")

			optionMacro = document.createElement("option")
			optionMacro.value = "macro"
			optionMacro.textContent = universal.translationKey("editor.sections.macro.control.action_macro")
