...
(function () {
	...
	ctx = function (o) {
		...
		if (arguments.length > 1) {
			...
			options.veiwBoxWidth = arguments[2];
			options.veiwBoxHeight = arguments[3];
		} else if (!o) {
			options = defaultOptions;
		} else {
			options = o;
		...
		this.veiwBoxWidth = options.veiwBoxWidth || this.width;
		this.veiwBoxHeight = options.veiwBoxHeight || this.height;
		...
		this.__root.setAttribute(
			"viewBox",
			"0 0 " + this.veiwBoxWidth + " " + this.veiwBoxHeight,
		);
