		...
		? (function () {
				...
				Drawing.prototype.draw = function (oQRCode) {
					...
					_htOption.realHeight =
						_htOption.heightWithTitle + _htOption.quietZone * 2;
					...
					if (_htOption.logo) {
						...
						var imgDivStyle =
							...
							(_htOption.height / 2 + imgH / 2 + _htOption.quietZone) +
					...
					var nTopMarginTable =
						(_htOption.heightWithTitle - elTable.offsetHeight) / 2;
		...
		: (function () {
				...
				function _onMakeImage() {
					if (this._htOption.drawer == "svg") {
						...
						function scaleCanvas(canvas, ctx, newWidth, newHeight) {
				...
				Drawing.prototype.draw = function (oQRCode) {
					...
					_htOption.heightWithTitle =
						calculatedQRHeight + _htOption.titleHeight;
					_htOption.realHeight =
						_htOption.heightWithTitle + _htOption.quietZone * 2;
					...
					if (_htOption.drawer != "canvas") {
						...
						this._oContext = new C2S(
							_htOption.width + this._htOption.quietZone * 2,
							_htOption.height +
								_htOption.titleHeight +
								this._htOption.quietZone * 2,
							_htOption.realWidth,
					...
					if (_htOption.backgroundImage) {
						...
						bgImg.onload = function () {
							...
							if (
								(_htOption.title || _htOption.subTitle) &&
								_htOption.titleHeight
							) {
								_oContext.drawImage(
									bgImg,
