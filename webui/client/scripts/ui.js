...
function makeBootLog() {
  ...
  thisbootLog.innerHTML =
    "<img src='/assets/logo_big.png' class='n-icon'><h1>Freedeck</h1><div style='display:none;' id='boot-log'><center class='oclb flex-wrap-r'><button id='oclb'>Close Boot Log</button></center></div>";
